...
Write-Host "ℹ️  Canonical: 14 type + 9 phase + 5 status + 4 priority labels" -ForegroundColor Cyan
Write-Host "ℹ️  Legacy labels created as grey fallbacks for backward compatibility" -ForegroundColor Cyan
